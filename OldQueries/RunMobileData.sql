...
BEGIN
      ...
      BEGIN
            ...
            insert into EarningType (PropertyID, Name, ProcessorCode, UOM, Type, EarningCategoryID, IncludeInBankedHours, IncludeInWorkedHours, IncludeInSalaryDistribution, AccrualFrequency, AllowNegativeBalance, IncludeInReallocation) values (@propertyID, @earningName, @processorCode, @UOM, 'E', @earningCategoryID, 'N', case when @UOM = 'H' then 'Y' else 'N' end, case when @UOM = 'H' then 'Y' else 'N' end, 'P', 'Y', 'N')
