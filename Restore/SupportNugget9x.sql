...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'Support_nugget_9x')
		BEGIN
			ALTER DATABASE [Support_nugget_9x]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_nugget_9x];
		END
RESTORE DATABASE [Support_Nugget_9x] FROM  DISK = N'L:\janugget_backup_2014_09_26_230001_6350469.bak' WITH  FILE = 1,  
MOVE N'janugget' TO N'G:\Support_nugget_9x.mdf',  
MOVE N'janugget_log' TO N'i:\Support_nugget_9x_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'Support_nugget_9x'
set @DBDesc = 'Support nugget 9x'
