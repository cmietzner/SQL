...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'support_mohonk_9x')
		BEGIN
			ALTER DATABASE [Support_Mohonk_9x]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_Mohonk_9x];
		END
RESTORE DATABASE [Support_Mohonk_9x] FROM  DISK = N'L:\mohonk_backup_2014_09_26_230001_6662487.bak' WITH  FILE = 1,  
MOVE N'Mohonk' TO N'G:\support_mohonk_9x.mdf',  
MOVE N'Mohonk_log' TO N'i:\support_mohonk_9x_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'support_mohonk_9x'
set @DBDesc = 'Support Mohonk 9x'
