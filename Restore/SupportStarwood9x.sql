...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'Support_Starwood_9x')
		BEGIN
			ALTER DATABASE [Support_Starwood_9x]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_Starwood_9x];
		END
RESTORE DATABASE [Support_Starwood_9x] FROM  DISK = N'L:\starwood80_backup_2014_09_26_230001_6818496.bak' WITH  FILE = 1,  
MOVE N'starwood80' TO N'G:\Support_Starwood_9x.mdf',  
MOVE N'starwood80_log' TO N'i:\Support_Starwood_9x_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'Support_Starwood_9x'
set @DBDesc = 'Support Starwood 9x'
