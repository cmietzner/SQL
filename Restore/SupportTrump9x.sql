...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'Support_Trump_9x')
		BEGIN
			ALTER DATABASE [Support_Trump_9x]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_Trump_9x];
		END
RESTORE DATABASE [Support_Trump_9x] FROM  DISK = N'L:\trump_backup_2014_09_26_230001_6974505.bak' WITH  FILE = 1, REPLACE,  
MOVE N'Trump' TO N'G:\Support_Trump_9x.mdf',  
MOVE N'Trump_log' TO N'i:\Support_Trump_9x_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'Support_Trump_9x'
set @DBDesc = 'Support Trump 9x'
