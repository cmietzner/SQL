...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'Support_KSL_9_01')
		BEGIN
			ALTER DATABASE [Support_KSL_9_01]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_KSL_9_01];
		END
RESTORE DATABASE [Support_KSL_901] FROM  DISK = N'L:\ksl_backup_2014_09_26_230001_6350469.bak' WITH  FILE = 1,  
MOVE N'KSL' TO N'G:\Support_KSL_9_01.mdf',  
MOVE N'KSL_log' TO N'i:\Support_KSL_9_01_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'Support_KSL_9_01'
set @DBDesc = 'Support KSL 901'
