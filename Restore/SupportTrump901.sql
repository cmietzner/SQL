...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'Support_Trump_9_01')
		BEGIN
			ALTER DATABASE [Support_Trump_9_01]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_Trump_9_01];
		END
RESTORE DATABASE [Support_Trump_9_01] FROM  DISK = N'L:\trump_backup_2014_09_26_230001_6974505.bak' WITH  FILE = 1,  
MOVE N'Trump' TO N'G:\Support_Trump_9_01.mdf',  
MOVE N'Trump_log' TO N'i:\Support_Trump_9_01_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'Support_Trump_9_01'
set @DBDesc = 'Support Trump 901'
