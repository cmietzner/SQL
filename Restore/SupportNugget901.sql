...
Use Master
GO
	IF EXISTS (SELECT * from sys.databases where name = 'Support_nugget_9_01')
		BEGIN
			ALTER DATABASE [Support_nugget_9_01]
			SET SINGLE_USER
			WITH ROLLBACK IMMEDIATE;
			DROP DATABASE [Support_nugget_9_01];
		END
RESTORE DATABASE [Support_Nugget_9_01] FROM  DISK = N'L:\janugget_backup_2014_09_26_230001_6350469.bak' WITH  FILE = 1,  
MOVE N'janugget' TO N'G:\Support_nugget_9_01.mdf',  
MOVE N'janugget_log' TO N'i:\Support_nugget_9_01_1.LDF',  NOUNLOAD,  STATS = 10
GO
...
set @DBName = 'Support_nugget_9_01'
set @DBDesc = 'Support nugget 901'
